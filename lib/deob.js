...
program.version(PACKAGE_CONFIG.version).
    ...
    option("-c, --config [config.json]", "Customize config files for deobfuscating").
...
if(program.config) {
    ...
    var config_file_name = join(dirname(inputFile), basename(inputFile, extname(inputFile))+".deob.json");
