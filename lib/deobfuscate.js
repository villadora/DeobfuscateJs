...
['U2/util.js','U2/parse.js', 'travese.js', 'inline.js'].forEach(function(file) {
...
merge(Deobfuscate.prototype, {
    ...
    before: function(topLevel) {
        ...
        if(this.option('inline')) {
            topLevel.transform(new InlineFunction({'aggressive':this.option('aggressive'),'fnames': this.option('inline_functions')}));
        }
...
DEFDEOB(AST_ObjectKeyVal, function(w) {
    ...
    if(w.options['arggressive']) {
        if(value instanceof AST_SymbolRef) {
            ...
            if(!is_identifier_string(key) || value.hasOwnProperty('_replaced')) {
                return;
            }
...
DEFDEOB(AST_VarDef, function(w) {
    ...
    if(value) {
        ...
        if(constants.hasOwnProperty(value_str)) {
            ...
            name.thedef.references.forEach(function(ref) {
                ref['_replaced'] = value.hasOwnProperty('_replaced') ? value['_replaced'].clone() : value.clone();
            });
